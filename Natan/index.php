...
<style>
    form {border:1px solid #000; padding: 20px; margin-top:25px; font:16px Arial, Helvetica, sans-serif;color:#000000;}
...
<body>
    <div class="Formulário" align="center">
        ...
        <form action="mkdir.php" method="post">
            ...
            <textarea id="buttor_dir" name="desc" placeholder="Descrição" rows="7" cols="50"></textarea><br>
